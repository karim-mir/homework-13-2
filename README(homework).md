...
Привет! Добро пожаловать в программу работы с банковскими транзакциями. Этот проект предоставляет инструменты для загрузки, фильтрации и отображения информации о банковских операциях из различных форматов (JSON, Excel, CSV).
...
1. Выбор типа входного файла:
   Вы можете выбрать, откуда загрузить данные о транзакциях:
   - Получить информацию о транзакциях из JSON-файла
   - Получить информацию о транзакциях из Excel-файла
...
2. Фильтрация транзакций:
   ...
   - Фильтрация по валюте (например, рублевые транзакции)
   - Дополнительная фильтрация по слову в описании.

3. Вывод информации:
   Программа выведет итоговый список транзакций и соответствующую информацию о каждой транзакции, включая дату, описание, сумму и код валюты.

### Пример использования

1. Запустите программу.
2. Выберите необходимый пункт меню.
3. Следуйте инструкциям на экране для получения информации о транзакциях.
4. Проводите фильтрацию и сортировку данных по вашим критериям.

### Зависимости

Проект требует следующие библиотеки:
- json
